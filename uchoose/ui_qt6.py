...
class Uchoose(QtWidgets.QWidget):
	...
	def center(self):
		...
		screen_center = QScreen.availableGeometry(screen).center()
		screen_center1 = screen.availableGeometry().center()
	
		# Approach like qt5
		# desktop.cursor().pos()
		_cursor_position = QCursor.pos()
		_screen = screen.virtualSiblingAt(_cursor_position)
		screen_center = _screen.availableGeometry().center()
		screen_center = _screen.availableGeometry().center()
		# screen_center = _.center()
